...
const ListItem = forwardRef(({ data }, ref) => {
  ...
  return (
    data.poster_path && (
      <li className='relative z-0 min-w-1/3 transform px-1 transition ease-in-out hover:z-20 hover:scale-110 sm:min-w-1/4 md:min-w-1/5 lg:min-w-1/6 xl:min-w-1/7 2xl:min-w-1/8'>
